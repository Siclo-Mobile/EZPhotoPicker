...
public class PhotoIntentHelperStorage {
  ...
  public String getLatestStoredPhotoBitmapAbsolutePath() {
    return getAbsolutePathOfStoredPhoto(loadLatestStoredPhotoDir(), loadLatestStoredPhotoName());
  }

  public String getLatestStoredPhotoBitmapThumbnailAbsolutePath() {
    return getAbsolutePathOfStoredPhoto(loadLatestStoredPhotoDir(), loadLatestStoredPhotoName() + PhotoIntentConstants.THUMB_NAME_SUFFIX);
  }
}
